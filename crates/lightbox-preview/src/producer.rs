...
use crate::pyramid::{
    derive_store_key, t0_rel_path, t1_rel_path, PreviewDesc, PreviewScope, ProducerId, Tier,
    VariantParams,
};
...
pub(crate) fn ensure_t0(
    ...
    let row = NewPreviewRow {
        ...
        recipe_rev: 0,
        colorspace: extracted.colorspace.as_catalog_str().to_owned(),
...
pub(crate) fn ensure_t1(
    ...
    let row = NewPreviewRow {
        ...
        source: PreviewSourceTag::Embedded,
        recipe_rev: 0,
        colorspace: colorspace.as_catalog_str().to_owned(),
        store_path: rel.as_str().to_owned(),
        width: w,
        height: h,
