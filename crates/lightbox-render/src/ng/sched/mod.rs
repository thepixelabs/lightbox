...
pub mod canvas;
// E10 Phase D tasks D12/D13: the canvas-adjacent histogram reduction + J-key
// clip-overlay pass (see each module's own doc for why they sit here rather
// than as `RenderNode`s).
