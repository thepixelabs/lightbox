...
/// Toggles the About window (identity, build facts, pixelabs.net).
pub const APP_ABOUT: ActionId = ActionId("app.about");
/// E15 core slice: open the Export dialog.
pub const APP_EXPORT: ActionId = ActionId("app.export");
...
/// E11: toggle the crop/straighten tool (the conventional photo-editor
/// binding, Lightroom's own Crop Overlay shortcut).
pub const GEOM_CROP_TOGGLE: ActionId = ActionId("geom.crop_toggle");
/// E10 task D13: toggle the on-canvas highlight/shadow clip overlay (the
...
pub fn default_registry() -> KeymapRegistry {
    ...
    let defs = [
        ...
        ActionDef {
            id: APP_ABOUT,
            // No default chord: About is a rarely-used, always-visible
            // top-bar button, and every unclaimed chord is worth more to
            // an editing command. Rebindable like anything else.
            label: "About Lightbox",
            category: "Application",
            contexts: &[CTX_APP],
            default: None,
            repeatable: false,
        ...
        ActionDef {
            ...
            category: "Application",
            contexts: &[CTX_APP],
            default: Some(Chord::cmd_shift(Key::E)),
            repeatable: false,
        },
        ActionDef {
            id: GEOM_CROP_TOGGLE,
            ...
            category: "Tools",
            contexts: &[CTX_LOUPE],
            default: Some(Chord::plain(Key::R)),
            repeatable: false,
        },
        ActionDef {
            id: HIST_CLIP_OVERLAY_TOGGLE,
            label: "Toggle clip-warning overlay",
            category: "View",
            contexts: &[CTX_LOUPE],
...
mod tests {
    ...
    fn m1_defaults_match_the_spec() {
        ...
        assert_eq!(display(GEOM_CROP_TOGGLE), "R");
        assert_eq!(display(HIST_CLIP_OVERLAY_TOGGLE), "J");
    }
}
