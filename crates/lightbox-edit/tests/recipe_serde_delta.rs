...
use lightbox_edit::{
    ...
    ParamValue, PostCropVignette, Presence, ProfileKind, ProfileRef, Recipe, RecipeRead, Sharpen,
    ToneCurve, ToneCurveSet, Transform, Treatment, Upright, WhiteBalance, RECIPE_SCHEMA,
};
...
fn arb_curveset() -> impl Strategy<Value = ToneCurveSet> {
    (arb_curve(), arb_curve(), arb_curve(), arb_curve()).prop_map(|(rgb, r, g, b)| ToneCurveSet {
        rgb,
        r,
        g,
        b,
